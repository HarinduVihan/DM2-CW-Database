...
SET DEFINE OFF;
Insert into SYSTEM.CUSTOMER_TABLE (CUSTOMER_ID,CUSTOMER_NAME,CUSTOMER_ADDRESS,CUSTOMER_TEL) values (43,'Sahas','colombo',123);
Insert into SYSTEM.CUSTOMER_TABLE (CUSTOMER_ID,CUSTOMER_NAME,CUSTOMER_ADDRESS,CUSTOMER_TEL) values (42,'Uvindu','Ragama',123);
--------------------------------------------------------
